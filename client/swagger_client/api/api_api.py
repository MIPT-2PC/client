...
class ApiApi(object):
    ...
    def operate(self, **kwargs):  # noqa: E501
        """operate 2 numbers  # noqa: E501

        operate 2 numbers with defined action  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.operate(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Nums body: Nums request body
        :return: list[Nums]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.operate_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.operate_with_http_info(**kwargs)  # noqa: E501
            return data

    def operate_with_http_info(self, **kwargs):  # noqa: E501
        """operate 2 numbers  # noqa: E501

        operate 2 numbers with defined action  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.operate_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[Nums]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
